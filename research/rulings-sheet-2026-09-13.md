<!--
Filed: 2026-09-13 (integration run, STEP 3)
Origin: prepared by Claude Code from the September-intake synthesis
(research/corpus-intake-assessment-2026-09-13.md §5(a)–(t)) and the
per-work assessments, after the chapter-by-chapter integration pass.
Reflective document — outside the provenance chain; nothing here may
be cited. Each row STATES a register decision; it does not recommend.
Draft sentences are quoted as the assessments quote them against the
3 September assembly (commit 6046676). Rows marked ⚑SPINE touch
spine.md or CLAUDE.md and are Roderick's alone: (b), (d), (k), (n).
RULING: ____ is to be filled by Roderick; the renovation pass applies
nothing until it is.
-->

# Rulings sheet — September intake register decisions

## (a) "Price" → establishment/entry/standing cost
DECISION: say establishment cost, entry cost, standing cost — never
unit price; re-grade "no subject could pay" to "no subject could
sustain it as a standing, provincial-scale instrument at campaign
tempo."
DRAFT SENTENCES: ch06 §VII "put the price of decisive force above
what any subject could pay"; ch10 §VII "Prices, however, are facts";
ch06 §VII the census "with one entry."
CARRIERS: Hoffman Tables 2.5–2.6 (pp. 61–63: artillery −1.4%/yr
1382–1439; handguns +3%/yr); Hall p. 58 (powder to a fifth), p. 120
(private siege trains), p. 130 (the administrative threshold);
...
"suppressing," every authority between crown and subject; CLAUDE.md
§2's chain and ch10 §I's sentence change with it.
DRAFT SENTENCES: ch10 §I "suppressing every authority between the
crown and the taxable subject"; CLAUDE.md §2 "suppression of
intermediate authorities."
CARRIERS: Tilly p. 25 ("no European state (except, perhaps, Sweden)
...
overlapping order was LOCKED into units while inter-unit plurality
hardened — not that the plural order was ended in 1440–1500; the
Coda's "ended within two generations" becomes "became irreversible
within two generations."
DRAFT SENTENCES: Introduction §I "ended by an identifiable
mechanism, at an identifiable price, in an identifiable
half-century"; Coda §VI "ended within two generations of that price
becoming payable."
CARRIERS: Strayer pp. 9, 31–34, 57, 91 (the 1300 state; "still not
...
and did not see what it bought — replacing "they did not understand
the hidden forces behind the artillery — the fiscal apparatus."
DRAFT SENTENCES: spine §8(e)6 as ruled 2 September; ch06 §V–VI
...
ACQUIRED the switch when the barons could no longer hold it, and
kept it; the lag and hybrid form stand, the verb "severs" does not.
DRAFT SENTENCES: ch12's severance framing of 1911 and the probe's
"severs the power switch."
CARRIERS: Yergin ch. 13 (the industry "crawling to Washington";
the TRC "under a disguise"; the state-run cartel kept voluntary in
...
DECISIVE CAPABILITY," not "consolidate a bloc."
DRAFT SENTENCES: Intro §III condition 4 ("canon without a fisc…
canon alone proves sufficient to consolidate a bloc").
CARRIERS: Zielonka pp. 9, 55–57 ("renders the rise of a European
state impossible"; "power politics at its best, even though the
...
exempts the Ottoman member; the variant is labelled
administrative-state-before-artillery, artillery locking it.
DRAFT SENTENCES: ch11 §V closing line; §IV "the most complete
...
decisive force to condition of SUSTAINING it; Castile named the
consolidated core of a composite.
DRAFT SENTENCES: ch11's four-polity "executed documentable variants
of the same five moves"; ch05 §VII "Aragon expanding."
...
masse" is true of the pike, the hand-gun and the drone, not of the
longbow; the metaphor's weapon is chosen with this in view.
DRAFT SENTENCES: spine §4's longbow framing as echoed in ch06 §VII
("raised by anybody with a valley or a town").
CARRIERS: Hall pp. 20, 38, 148 ("None but the king of England could
...
first (Charles V, 1360s) having been reversed in 1380 — the
strongest evidence that irreversibility, not permanence, is the
explanandum.
DRAFT SENTENCES: ch10 §III "The constitutional theory of French
taxation before 1439 was consent: the Estates granted, for a
purpose and a term, and the grant lapsed."
...
the dissolution named as its fisc, or spine §3's "standing taxation
established" is rewritten for England; the ch11 §§I–II Henry VII
passages are wrong as written whichever way.
DRAFT SENTENCES: ch11 §II "retained, to the letter, his father's
machine"; the Henry VII-as-consolidator framing; spine §3.
CARRIERS: Lander pp. 13, 39–40, 54–55, 71–73, 292, 298–99; Grummitt
...
permanence, plus one mortal node) is attributed as the book's own
inference from Depreter's evidence; "intact" and "guns" leave the
transfer sentence; the EU test carries two variables.
DRAFT SENTENCES: ch10 §VI "What Burgundy lacked … was not
administrative capacity — Depreter's work shows the capacity in
detail — but a survivable dynastic centre"; "transferred the whole
apparatus intact — lands, revenues, recette and guns"; ch04 §VII
...
carries the "conversion failed" cell (Ágoston pp. 121–23); the
platform chapters name absorption-undone-by-the-absorbed-capability
as the fifth failure mode.
DRAFT SENTENCES: ch11 §IV's close as drafted; §V's closing line
(with (g)).
...
CORE polity and rules the rest by contract, aeque principaliter;
ch12 §IV states the American and Chinese readings in Solórzano's
two legal forms.
DRAFT SENTENCES: ch11 §V "the Habsburg composite followed its own
path a generation later"; the four-polity five-moves claim; the
...
bought enforcement, not law; the England line (toleration as the
price of a crown that could not pay for the alternative) is
carried at (c), graded plausible-unproven.
DRAFT SENTENCES: ch08 §VII "The plural legal environment was not
argued out of existence; it was outspent"; §I "the courts followed
...
"second capital-intensive medium" goes; the platform parallel is
to steam, not Gutenberg; ch11 §V states the disanalogy (cannon the
weapon subjects could not replicate; the press the one they always
could) and ch12 gains the 1670–88 quo warranto as the worked
example of absorption attempted and reversed; "delegated
enforcement to a chartered guild" becomes "chartered a guild that
took enforcement, and much else, into its own hands."
DRAFT SENTENCES: ch11 §V "the second capital-intensive medium";
"the state… could license, mandate and administer"; "delegated
enforcement to a chartered guild"; the "mirror-move" Index
sentence; the standardised/mandated wording.
...
RULING: YES — the first option: print stays as a second instance, "capital-intensive" goes, the harness was the canon and the register, the press stated as the weapon subjects could always replicate (a disanalogy the mechanism survives); the 1670–88 quo warranto goes to ch12 (Roderick, 2026-09-16)

## (q) The papal template restated per Morris
DECISION: ch02's template is a JURISDICTION, not a sovereignty —
emergency powers, casualiter, jurisdiction over sin — with Ullmann
demoted to superseded footnote; the papal fisc enters as the
disanalogy (a universalism that could not pay for force).
DRAFT SENTENCES: ch02 §II's Dictatus-as-monarchic-answer, the
Worms partition, Canossa's reach, Innocent-at-the-apex; the
...
cite Belloc (with B. T. B.) for the SYNDROME — faith in the
instrument, private monopoly without the process — paired with
Talbot per §8(f); Freedman-and-Holman carry the knock-out-blow
genealogy.
DRAFT SENTENCES: ch06 §VI "the satirist's Maxim-gun couplet and
its twentieth-century heirs" among "the prophets of the knock-out
blow."
...
terminological collision (his "ratchet" = slow cumulative technical
evolution, approvingly; the spine's = the irreversibility point);
every DeVries pin cited as a witness testifying against his own
frame, with Hale's dissent named.
DRAFT SENTENCES: the ch06/ch10 DeVries citations as they stand
(no single sentence; a use-note discipline).
CARRIERS: DeVries XVIII 470 (Buchanan's ratchet-evolution); XVI
...
mutual-aid compact) and drops any suggestion the commons were
absorbed; "on schedule … the same fate" becomes "under a
probability the state's fiscal reach kept raising"; the
forty-seven-cannon point is stated as the captured-not-cast proof.
...
# RE-SOURCE OR CUT (STEP 1.4 negative closures — one row each)

## R1. The Cade pardon roll (ch07 §I)
The "gentry skeleton" footnote cites Griffiths pp. 619–21 for the
opposite of what he says ("quite unwarranted"; "a cross-section of
...
*War in European History* (no Castillon, no Formigny, text or
index; assessor's guess: a misremembered Bert Hall). Restage the
...
| (y) [decision 4] | Recast Talbot as the expert whose system stopped supplying the means; keep the plot/intention distinction visible | ch06 §VI | Barker (Dieppe); Vale (Caen plot) | No (within §8(e)/(f)) | YES WITH CAVEATS — "Talbot may or may not be a good military commander; the evidence is mixed. On the one hand he lost battles, and famously the last one. On the other, his fame survived a hundred years into the Shakespearean history plays, and he was clearly feared by contemporaries." The recast must carry that ambivalence, not resolve it (Roderick, 2026-09-16) |
...
| (aa) [decision 6 — rule with (a)] | Drop "controlled comparisons"; restate the proof as an organised system making resistance unaffordable; establishment v. weapon, planned v. collected | ch06 §§I, VII; ch10 | Barker; Hall; Depreter; Cosneau; Grummitt | No | YES — the restatement: "controlled comparisons" dropped; ch06's proof is an organised system that made continued resistance unaffordable; establishment v. weapon, collected v. planned (Roderick, 2026-09-16) |
