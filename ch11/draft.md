...
*DRAFT (first draft, 2026-08-02) — written against ch11/memo.md (REVIEWED
2026-07-31, with Addendum), ch11/critiques.md, and ch11/sources.md;
written after all prior reviewed drafts, weighted to ch10, carrying the
ch04 functional-vs-formal thread and the ch10 Depreter refinement per the
brief's instruction. Author–date citations inline; conventions as
established. §VIII carries [RE-CHECK AT PRESS] entire.*
...
When the old king died, the new one cancelled the rest (Ross 2021,
open, the case reconstructed from the records). Observe the
...
Fourth to the time of Elizabeth" (Green 1874, ch. VI — the coinage
quotable at source, in this book's corpus), and the early twentieth
...
another: bond, attainder, fine or constraint (the exact tallies
...
readings are not exclusive). The machine's administrative organ
...
"an instrument no coalition could break" (Contamine 1964: 261
[TRANS. CLAUDE]). The first continental adventure of the
...
(the debate staged in Ekinci 2018, open); and it reached for
...
ownership (Özel, open), and Bayezid II partially restored what
...
controversialists put together" (Edwards, open). But the state's
...
covering some thirteen trillion euros (OECD peer review,
2025); the Pillar Two minimum tax is law in fifty-odd
...
Anthropic's technology" (GSA, 27 February 2026); the firm's
suit (N.D. Cal.); a preliminary injunction (26 March 2026);
...
development). Voice-discipline ledger (counted as produced):
coined concept — NONE ("New Monarchy" is Green's, quoted at
T1; the five-move schema is (c) but not a coinage); vivid image
— absorption "performed with the Church's own silverware"
(§III); aphoristic line — "a fine never meant to be collected,
only to convert a magnate into a bondholder of his own
obedience" (§I, the memo's reviewed candidate). One [BRIDGE]
section (§VI), carrying [RE-CHECK AT PRESS] entire. [GAP]
flags: Wolffe/Chrimes; Lander; Elliott/Kamen; İnalcık; Febvre
& Martin. Corrections carried: Lander 36/62 not two-thirds;
Bergavenny assessed-commuted-cancelled per Ross; Santiago
1499; annexation 1523; janissary range hedged; kanunname
debate staged; Özel caveat; the Pillar Two carve-out, FTC
