...
*DRAFT (first draft, 2026-07-31) — written against ch07/memo.md (REVIEWED,
Revisions 1–7), ch07/cade-composition.md (REVIEWED), ch07/critiques.md, and
the T1 Complaint text; opens where ch06/draft.md closes (the veterans and
the bill for Normandy), per the Batch 1 continuity instruction. Author–date
citations inline; [BRIDGE] and [GAP] conventions as in ch06.*
...
(Watts, ch. 6). Kent, the county through which the wreckage of the
...
Curry's summary, "took to living off the land" (Curry 2010: 186–87),
...
single document (Landesarchiv Baden-Württemberg). The urban
...
"hegemonic status, power, and privilege are fading" (Norris &
Inglehart, ch. 1 — cited by chapter from the pre-publication text
in repo); Fetzer's austerity findings and Margalit's adjudication
...
roughly $56,000 (Norris & Inglehart; Green & Pahontu 2024; Silver
2016, corroborated by Manza & Crowley 2017). The pattern has named
...
(Girardi 2024); the gilets jaunes complicate it — working and
...
Leave voters' own first-ranked reason (Ashcroft polling: 49 per
cent); the gilets jaunes demanded the "refoundation" — not the
...
rather than to climate denial (Douenne & Fabre 2022). The
...
2028-29" (OBR, March 2024). The gilets jaunes won their carbon-tax
...
## Revisions (post-review, second series)

2. **(2026-08-04.)** §I's Bohna citation upgraded from abstract level
